 ...
 * 
 */
@WebServiceClient(name = "LoginService", targetNamespace = "http://security.webservices.bankfusion.trapedza.com", wsdlLocation = "http://blrl10tl5y2:9083/bfweb/services/LoginService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGINSERVICE_QNAME = new QName("http://security.webservices.bankfusion.trapedza.com", "LoginService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://blrl10tl5y2:9083/bfweb/services/LoginService?wsdl");
     ...
     * 
     * @return
     *     returns LoginSerivce
     */
    @WebEndpoint(name = "LoginPort")
    public LoginSerivce getLoginPort() {
        return super.getPort(new QName("http://security.webservices.bankfusion.trapedza.com", "LoginPort"), LoginSerivce.class);
    }
     ...
     */
    @WebEndpoint(name = "LoginPort")
    public LoginSerivce getLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://security.webservices.bankfusion.trapedza.com", "LoginPort"), LoginSerivce.class, features);
    }
