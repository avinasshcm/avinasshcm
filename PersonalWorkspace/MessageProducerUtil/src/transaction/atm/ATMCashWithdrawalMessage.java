...
public class ATMCashWithdrawalMessage implements Runnable {
	HashMap<Integer, ATMTxnData> data = new HashMap<Integer, ATMTxnData>();
	String numberOfTxns = "1";
	private static final Logger LOGGER = Logger.getLogger(ATMCashWithdrawalMessage.class.getName());
	QueueConnectionFactory factory = new MQQueueConnectionFactory();
	CommonMethods commonMethods = new CommonMethods();

	public ATMCashWithdrawalMessage() {
	}

	public ATMCashWithdrawalMessage(QueueConnectionFactory factory, String numberOfTxns) {
	...
	public void run() {
		...
		String originalMessage = readFileAsString("templates/Request_ATM_CASHWITH.xml");
