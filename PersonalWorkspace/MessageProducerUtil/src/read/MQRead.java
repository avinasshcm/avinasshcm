...
public class MQRead {
	...
	public int port = 1440;
	public String hostname = "BLRL10TL5Y2";
	public String channel = "SYSTEM.ADMIN.SVRCONN";
	public String qManager = "CTT_4261_BFDC";
	public String inputQName = "UB_IND_CustEnablQ";
