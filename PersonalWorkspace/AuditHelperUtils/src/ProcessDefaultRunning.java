...
public class ProcessDefaultRunning {
	...
	public static void main(String[] args) throws Exception {
		...
		HashMap<String, AuditPojo> MSGMap = new HashMap<String, AuditPojo>();
	...
	private static void readTime(HashMap<String, AuditPojo> FBPMap, String[] lineItems) throws ParseException {
		int index = getIndexOf(lineItems, "MessageGUID") + 1;
	...
	private static void printResults(Map.Entry<String, AuditPojo> entry, AuditPojo ap, long timeTaken, long delay) {
