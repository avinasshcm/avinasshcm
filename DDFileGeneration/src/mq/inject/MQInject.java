...
public class MQInject {
    ...
    public int port = 1423;

    public String hostname = "BLRCSWESNL30019";

    public String channel = "QM_CTT_426_MPM.DLQ";

    public String qManager = "QM_CTT_426_MPM";

    public String inputQName = "DLQ";

    public String outputQName = "DLQ";
